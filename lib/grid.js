var Grid = (function() {
  function Grid(horizontalBlocks, verticalBlocks, screenBounds) {
    ...
    this.blockWidth = Math.round(this.screenBounds.width / this.horizontalBlocks)
    this.blockHeight = Math.round(this.screenBounds.height / this.verticalBlocks)
  }
  ...
  Grid.prototype.boundsForGridCoordinates = function(gridCoordinates) {
    var x = gridCoordinates.x * this.blockWidth + this.screenBounds.x;
    var y = gridCoordinates.y * this.blockHeight + this.screenBounds.y;
    var w = gridCoordinates.width * this.blockWidth;
    var h = gridCoordinates.height * this.blockHeight;
